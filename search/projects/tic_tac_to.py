...
if player(s) == "O":
    ...
    return best_action  # Return the optimal 
else:
    best_action = None  # Initialize best action found
...
return actions_set  # Return sey of available moves
```
...
return None  # No winner, return neutral utility
```
